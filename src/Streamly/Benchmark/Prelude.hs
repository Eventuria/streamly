...
zip :: Int -> Int -> IO ()
zip count n =
    S.drain $ S.zipWith (,) (sourceUnfoldrMN count n)
...
zipM :: Int -> Int -> IO ()
zipM count n =
    S.drain $ S.zipWithM (curry return) (sourceUnfoldrMN count n)
                       (sourceUnfoldrMN count (n + 1))
...
mergeBy :: Int -> Int -> IO ()
mergeBy count n =
    S.drain $ S.mergeBy P.compare (sourceUnfoldrMN count n)
                       (sourceUnfoldrMN count (n + 1))
...
serial2 :: Int -> Int -> IO ()
serial2 count n =
    S.drain $ S.serial (sourceUnfoldrMN count n)
                       (sourceUnfoldrMN count (n + 1))

{-# INLINE serial4 #-}
serial4 :: Int -> Int -> IO ()
serial4 count n =
    S.drain $ S.serial ((S.serial (sourceUnfoldrMN count n)
                        (sourceUnfoldrMN count (n + 1))))
...
append2 :: Int -> Int -> IO ()
append2 count n =
    S.drain $ Internal.append (sourceUnfoldrMN count n)
                       (sourceUnfoldrMN count (n + 1))

{-# INLINE append4 #-}
append4 :: Int -> Int -> IO ()
append4 count n =
    S.drain $ Internal.append ((Internal.append (sourceUnfoldrMN count n)
                        (sourceUnfoldrMN count (n + 1))))
...
{-# INLINE wSerial2 #-}
wSerial2 :: Int -> IO ()
wSerial2 n = S.drain $ S.wSerial (sourceUnfoldrMN (value `div` 2) n)
...
concatMap outer inner n =
    S.drain $ S.concatMap (\_ -> sourceUnfoldrMN inner n)
...
concatMapPure outer inner n =
    S.drain $ S.concatMap (\_ -> sourceUnfoldrN inner n)
...
concatUnfoldRepl4xN n = S.drain $ Internal.concatMapU (UF.replicateM 4)
                          (sourceUnfoldrMN (value `div` 4) n)
...
concatMapWithSerial outer inner n =
    S.drain $ S.concatMapWith S.serial (\_ -> sourceUnfoldrMN inner n)
                          (sourceUnfoldrMN outer n)
...
concatMapWithAppend outer inner n =
    S.drain $ S.concatMapWith Internal.append (\_ -> sourceUnfoldrMN inner n)
                          (sourceUnfoldrMN outer n)
...
concatMapWithWSerial outer inner n =
    S.drain $ S.concatMapWith S.wSerial (\_ -> sourceUnfoldrMN inner n)
                          (sourceUnfoldrMN outer n)
